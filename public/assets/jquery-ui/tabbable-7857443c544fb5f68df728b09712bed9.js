 ...
 */
function(e){"function"==typeof define&&define.amd?define(["jquery","./version"],e):e(jQuery)}(function(e){function n(e){for(var n=e.css("visibility");"inherit"===n;)e=e.parent(),n=e.css("visibility");return"hidden"!==n}return e.ui.focusable=function(i,t){var u,r,o,f,a,s=i.nodeName.toLowerCase();return"area"===s?(u=i.parentNode,r=u.name,!(!i.href||!r||"map"!==u.nodeName.toLowerCase())&&(o=e("img[usemap='#"+r+"']"),o.length>0&&o.is(":visible"))):(/^(input|select|textarea|button|object)$/.test(s)?(f=!i.disabled)&&(a=e(i).closest("fieldset")[0])&&(f=!a.disabled):f="a"===s?i.href||t:t,f&&e(i).is(":visible")&&n(e(i)))},e.extend(e.expr[":"],{focusable:function(n){return e.ui.focusable(n,null!=e.attr(n,"tabindex"))}}),e.ui.focusable}),/*!
